function layer3(knvs,rnds = 30,radd = 1, inc = 24) {
        ...
        if (fVals[i] >= upperLimit) {
            ...
            */
            ...
            for(y = yStop; y > yStart; y -= increment) {
                for(x = xStop; x > xStart; x -= increment) {
                    ...
                    isoRight(knvs, posX + 1 * unit, posY - (x- xStart) * tan(30) + grid[i][3] / 2 * tan(30), rnds * unit + 200 * knvs.abs(n2), 90, rds, kolor1, kolor2);
